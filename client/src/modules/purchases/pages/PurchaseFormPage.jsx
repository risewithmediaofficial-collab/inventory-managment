      ...
      <form onSubmit={handleSubmit((d) => mutation.mutate(d))} className="space-y-5">
        ...
        <div className="card p-5 grid grid-cols-3 gap-5">
          <div className="col-span-2 form-group">
            ...
            <Select options={supplierOptions} onChange={(o) => setValue('supplier', o?.value)} placeholder="Select supplier" classNamePrefix="react-select" />
          </div>
            ...
            <table className="table min-w-[700px]">
              ...
              <tbody>
                {fields.map((field, idx) => {
                  ...
                  return (
                    <tr key={field.id}>
                      <td><Select options={productOptions} onChange={(o) => { setValue(`items.${idx}.product`, o?.value); setValue(`items.${idx}.unitPrice`, o?.price || 0); }} placeholder="Select" classNamePrefix="react-select" menuPortalTarget={document.body} /></td>
                      ...
                      <td><Select options={taxOptions} onChange={(o) => setValue(`items.${idx}.taxRate`, o?.value || 0)} placeholder="Tax" classNamePrefix="react-select" menuPortalTarget={document.body} /></td>
