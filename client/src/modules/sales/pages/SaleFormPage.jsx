      ...
      <form onSubmit={handleSubmit((d) => mutation.mutate(d))} className="space-y-5">
        ...
        <div className="card p-5 grid grid-cols-3 gap-5">
          <div className="col-span-2 form-group">
            ...
            <Select options={customerOptions} onChange={(o) => setValue('customer', o?.value)} placeholder="Select customer" classNamePrefix="react-select" />
          </div>
              ...
              <tbody>
                {fields.map((field, idx) => {
                  ...
                  return (
                    <tr key={field.id}>
                      <td>
                        <Select options={productOptions} onChange={(o) => handleProductSelect(idx, o)} placeholder="Select product" classNamePrefix="react-select" menuPortalTarget={document.body} />
                      </td>
                      ...
                      <td>
                        <Select options={taxOptions} value={taxOptions.find((o) => o.value === +item.taxRate) || null} onChange={(o) => setValue(`items.${idx}.taxRate`, o?.value || 0)} placeholder="Tax" classNamePrefix="react-select" menuPortalTarget={document.body} />
                      </td>
